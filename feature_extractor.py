...
# Load image
image = Image.open(
    "dataset/Plant_leave_diseases_dataset_without_augmentation/Apple___Apple_scab/image (1).JPG"
).convert("RGB")
...
transform = transforms.Compose([
    ...
    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]),  # Normalize for visualization
